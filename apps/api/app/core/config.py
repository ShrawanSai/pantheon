...
def get_settings() -> Settings:
    ...
    return Settings(
        ...
        orchestrator_manager_model_alias=os.getenv("ORCHESTRATOR_MANAGER_MODEL_ALIAS", "gemini-flash"),
        summarizer_model_alias=os.getenv("SUMMARIZER_MODEL_ALIAS", "gemini-flash"),
